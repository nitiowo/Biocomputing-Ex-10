#Exercise10 Justin Detweiler

#Problem1- Score Graph
#Set Working Directory
setwd("/Users/justin/Desktop/tutorial/Biocomputing-Ex-10")
...
ggplot()+geom_line(data=BasketballData1, 
      aes(x=time, y=MSU_Score), 
      color="green")+geom_line(data=BasketballData1,
      aes(x=time, y=UW_Score), 
      color="red")+xlab("Time")+ ylab("Team Scores")
